 ...
 */
class getDoctrine_Orm_DefaultEntityManagerService extends App_KernelXecuteDebugContainer
{
    /**
    ...
    {
        if (true === $lazyLoad) {
            return $container->services['doctrine.orm.default_entity_manager'] = $container->createProxy('EntityManagerGhostDd3caf0', fn () => \EntityManagerGhostDd3caf0::createLazyGhost(fn ($proxy) => self::do($container, $proxy)));
        }
