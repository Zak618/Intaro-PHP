 ...
 */
class getRouting_LoaderService extends App_KernelXecuteDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\Routing\AnnotatedRouteControllerLoader(($container->privates['annotations.cached_reader'] ?? $container->getAnnotations_CachedReaderService()), 'xecute');

        $a->addLoader(new \Symfony\Component\Routing\Loader\XmlFileLoader($b, 'xecute'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\YamlFileLoader($b, 'xecute'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\PhpFileLoader($b, 'xecute'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\GlobFileLoader($b, 'xecute'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\DirectoryLoader($b, 'xecute'));
